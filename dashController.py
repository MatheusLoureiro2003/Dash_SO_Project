...
from processModel import dicionarioStatusProcesso, dicionarioStatCPUProcesso, atualizar_cpu_total, dicionarioPaginaProcesso,ler_cpu_total, processosTodos, cpuProcesso, snapshot, calcular_usos
